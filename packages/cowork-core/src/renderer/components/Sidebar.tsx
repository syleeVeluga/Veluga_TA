...
export function Sidebar() {
  ...
  if (sidebarCollapsed) {
    return (
      <aside className="w-[4.5rem] bg-surface/96 border-r-[3px] border-border flex flex-col overflow-hidden">
        <div className="px-3 pt-4 pb-3 flex flex-col items-center gap-2 border-b-[3px] border-border">
          <button
        ...
        <div className="px-3 py-3 border-t-[3px] border-border flex flex-col items-center gap-2">
          <button
            onClick={toggleTheme}
            className="w-9 h-9 rounded-2xl flex items-center justify-center hover:bg-surface-hover transition-colors text-text-secondary"
  ...
  return (
    <aside className="w-[17.5rem] bg-surface/96 border-r-[3px] border-border flex flex-col overflow-hidden">
      <div className="px-4 pt-5 pb-4 border-b-[3px] border-border">
      ...
      {isSelectMode ? (
        <div className="px-3 py-3 border-t-[3px] border-border">
          {showDeleteConfirm ? (
