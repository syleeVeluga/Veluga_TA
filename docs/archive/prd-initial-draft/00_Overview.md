...
> Archived: 이 문서는 2026-05-23 초기 PRD 초안 보관본입니다. 현재 요구사항이나 구현 지침으로 사용하지 마세요.
...
| **Phase 3** | 6~8주 | "외부 KB Consumer" | KB MCP **consumer 어댑터** + A2 Knowledge Gate + A3 Skill Resolver + gov-proposal Skill (외부 KB는 의존만) | ✅ 구현 완료 |
| **Phase 4** | 6~8주 | "결재 라인 진입" | citation-tracer (graph consumer) + compliance-checker full + approval-queue Artifact + Docker 샌드박싱 | ✅ 구현 완료 |
