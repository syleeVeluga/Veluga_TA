# Veluga Agents — archived initial PRD draft

> Archived: 이 폴더는 2026-05-23 초기 PRD 초안 보관본입니다. 현재 요구사항이나 구현 지침으로 사용하지 마세요. 현재 근거는 `docs/reference/`, 활성 `docs/plans/`, 그리고 소스 코드입니다.
