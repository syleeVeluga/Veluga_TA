...
- Veluga 화이트아웃 정책: [docs/reference/whiteout-endpoints.md](../../reference/whiteout-endpoints.md)
- Veluga 오케스트레이션 보안 모델: [agent-orchestration-plan §하드 제약](../agent-orchestration/00-overview.md)
