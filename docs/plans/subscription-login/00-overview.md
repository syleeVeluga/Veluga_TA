...
| HC-2 | **pi-ai / pi-coding-agent 수정 금지** | upstream clone snapshot 정책 ([agent-orchestration-plan](../agent-orchestration/00-overview.md)와 동일) — `setRuntimeApiKey()` 등 공개 API만 사용 |
