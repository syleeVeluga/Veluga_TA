...
2. **pi-ai/pi-coding-agent는 수정 금지** — clone snapshot 정책을 따라 외부에서 `AuthStorage.setRuntimeApiKey()` API만 활용 (참조: [agent-orchestration-plan](../agent-orchestration/README.md) §핵심 전제 1)
